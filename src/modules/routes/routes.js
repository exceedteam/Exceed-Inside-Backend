...
const { getUser, getAllUser, createUser, editUser, deleteUser, GetAllUserEvent } = require("../controllers/user.controller");
const { getAllPosts, getPost, createPost, editPost, deletePost, GetAllpostsUser } = require("../controllers/post.controller");
const { getAllComments, createComment, editComment, deleteComment } = require("../controllers/comment.controller");
const {
  getAllEvents,
  getEvent,
  createEvent,
...
router.put("/post/:postId/comment/:commentId", auth, editComment, getAllComments);
...
router.put("/events/subscribe", auth, subscribeAllEvents, GetAllUserEvent);
...
router.post("/event", auth, createEvent, getAllEvents);
